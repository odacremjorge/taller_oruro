...
class Request(models.Model):
    cat=(('Maestranza','Maestranza'),('Vehiculos pesados','Vehiculos pesados'),('Motocicletas','Motocicletas'),('Vehiculos livianos','Vehiculos livianos'))
    ...
    stat=(('Pendiente','Pendiente'),('Aprobado','Aprobado'),('Reparando','Reparando'),('Reparacion Finalizada','Reparacion Finalizada'),('Liberado','Liberado'))
